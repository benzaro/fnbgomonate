        ...
        <div className="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-[var(--background-card)] border-b border-[var(--border)]">
            <div className="flex-1 px-6 flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                    {/* Notifications */}
                    <button className="p-2 rounded-xl hover:bg-[var(--background)] transition-colors relative">
                        <svg className="w-5 h-5 text-[var(--muted)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                        </svg>
                        <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-[var(--fnb-orange)] rounded-full"></span>
                    </button>
